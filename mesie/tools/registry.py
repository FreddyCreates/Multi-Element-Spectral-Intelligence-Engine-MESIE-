...
TOOLS: List[NativeTool] = [
    ...
    NativeTool("auro-speaking", "Auro Native Speaking Intelligence", "mesie-neuroaix", "neuroaix",
               "Medina native speaking AI — voice, memory, affect, authority (Paper IV). Zero third-party inference.",
               ["auro", "speaking intelligence", "native voice", "alpha family", "thesis defer"],
