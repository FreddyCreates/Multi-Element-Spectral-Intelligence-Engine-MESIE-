"""Agent Noctis Phi — Dark Mode φ intelligence agent."""
...
PARADIGM_ID = "dark_mode_phi"
LATIN_AGENT = "Agent Noctis Phi"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Noctis Phi — routes to MESIE engine control."""
