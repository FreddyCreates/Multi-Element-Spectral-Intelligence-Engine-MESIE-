"""Agent Iconographia — Spectral Icon Set intelligence agent."""
...
PARADIGM_ID = "icon_spectral"
LATIN_AGENT = "Agent Iconographia"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Iconographia — routes to MESIE engine fingerprint."""
