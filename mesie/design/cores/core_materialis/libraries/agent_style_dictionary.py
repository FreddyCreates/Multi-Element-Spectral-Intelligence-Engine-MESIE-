"""Agent Style Polyglotta — Style Dictionary intelligence agent."""
...
PARADIGM_ID = "style_dictionary"
LATIN_AGENT = "Agent Style Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Style Polyglotta — routes to MESIE engine matching."""
