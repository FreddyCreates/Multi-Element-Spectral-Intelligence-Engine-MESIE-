"""Agent Less Polyglotta — Less Hierarchy intelligence agent."""
...
PARADIGM_ID = "less_hierarchy"
LATIN_AGENT = "Agent Less Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Less Polyglotta — routes to MESIE engine generation."""
