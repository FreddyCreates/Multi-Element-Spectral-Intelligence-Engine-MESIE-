"""Agent Classis Utilitas — Tailwind Utility intelligence agent."""
...
PARADIGM_ID = "tailwind_utility"
LATIN_AGENT = "Agent Classis Utilitas"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Classis Utilitas — routes to MESIE engine generation."""
