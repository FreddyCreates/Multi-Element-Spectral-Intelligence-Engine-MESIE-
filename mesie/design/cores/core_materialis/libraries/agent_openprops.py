"""Agent Open Polyglotta — Open Props intelligence agent."""
...
PARADIGM_ID = "openprops"
LATIN_AGENT = "Agent Open Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Open Polyglotta — routes to MESIE engine embedding."""
