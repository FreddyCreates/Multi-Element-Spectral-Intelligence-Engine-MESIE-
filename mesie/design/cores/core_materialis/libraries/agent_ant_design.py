"""Agent Ant Polyglotta — Ant Design intelligence agent."""
...
PARADIGM_ID = "ant_design"
LATIN_AGENT = "Agent Ant Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Ant Polyglotta — routes to MESIE engine movement."""
