"""Agent Variabilis Cascada — CSS Custom Properties intelligence agent."""
...
CORE_ID = "core_materialis"
PARADIGM_ID = "css_variables"
LATIN_AGENT = "Agent Variabilis Cascada"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Variabilis Cascada — routes to MESIE engine embedding."""
