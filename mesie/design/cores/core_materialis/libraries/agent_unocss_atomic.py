"""Agent UnoCSS Polyglotta — UnoCSS Atomic intelligence agent."""
...
PARADIGM_ID = "unocss_atomic"
LATIN_AGENT = "Agent UnoCSS Polyglotta"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent UnoCSS Polyglotta — routes to MESIE engine workflow."""
