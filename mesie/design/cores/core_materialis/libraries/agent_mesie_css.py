"""Agent Medina Stylus — MESIE mesie.css intelligence agent."""
...
PARADIGM_ID = "mesie_css"
LATIN_AGENT = "Agent Medina Stylus"
ROLE = "orchestrator"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Medina Stylus — routes to MESIE engine validation."""
