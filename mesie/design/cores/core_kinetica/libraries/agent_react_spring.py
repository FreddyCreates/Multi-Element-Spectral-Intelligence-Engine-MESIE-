"""Agent React Polyglotta — React Spring intelligence agent."""
...
PARADIGM_ID = "react_spring"
LATIN_AGENT = "Agent React Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent React Polyglotta — routes to MESIE engine embedding."""
