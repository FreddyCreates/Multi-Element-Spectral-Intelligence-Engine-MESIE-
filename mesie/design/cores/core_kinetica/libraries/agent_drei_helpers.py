"""Agent drei Polyglotta — drei Helpers intelligence agent."""
...
PARADIGM_ID = "drei_helpers"
LATIN_AGENT = "Agent drei Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent drei Polyglotta — routes to MESIE engine intelligence."""
