"""Agent GSAP Polyglotta — GSAP Plugins intelligence agent."""
...
PARADIGM_ID = "timeline_gsap_plugins"
LATIN_AGENT = "Agent GSAP Polyglotta"
ROLE = "orchestrator"
MESIE_ENGINE = "logic"
STACK = "gsap_plugins"
LANGUAGE = "wasm"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent GSAP Polyglotta — routes to MESIE engine logic."""
