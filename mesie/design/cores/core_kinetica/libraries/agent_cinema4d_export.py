"""Agent C4D Polyglotta — C4D Export Lane intelligence agent."""
...
PARADIGM_ID = "cinema4d_export"
LATIN_AGENT = "Agent C4D Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent C4D Polyglotta — routes to MESIE engine movement."""
