"""Agent Theatre.js Polyglotta — Theatre.js intelligence agent."""
...
PARADIGM_ID = "theatrejs_studio"
LATIN_AGENT = "Agent Theatre.js Polyglotta"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Theatre.js Polyglotta — routes to MESIE engine workflow."""
