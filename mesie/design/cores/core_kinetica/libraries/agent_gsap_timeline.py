"""Agent Tempus Linealis — GSAP Timeline intelligence agent."""
...
PARADIGM_ID = "gsap_timeline"
LATIN_AGENT = "Agent Tempus Linealis"
ROLE = "orchestrator"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Tempus Linealis — routes to MESIE engine workflow."""
