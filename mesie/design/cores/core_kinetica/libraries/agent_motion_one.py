"""Agent Motion Polyglotta — Motion One intelligence agent."""
...
PARADIGM_ID = "motion_one"
LATIN_AGENT = "Agent Motion Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Motion Polyglotta — routes to MESIE engine generation."""
