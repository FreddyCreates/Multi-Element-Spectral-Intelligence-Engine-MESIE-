"""Agent Animatio Vectoris — Lottie Vector intelligence agent."""
...
PARADIGM_ID = "lottie_vector"
LATIN_AGENT = "Agent Animatio Vectoris"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Animatio Vectoris — routes to MESIE engine generation."""
