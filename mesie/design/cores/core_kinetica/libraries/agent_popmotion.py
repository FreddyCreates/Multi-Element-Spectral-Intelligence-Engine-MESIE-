"""Agent Popmotion Polyglotta — Popmotion intelligence agent."""
...
PARADIGM_ID = "popmotion"
LATIN_AGENT = "Agent Popmotion Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Popmotion Polyglotta — routes to MESIE engine matching."""
