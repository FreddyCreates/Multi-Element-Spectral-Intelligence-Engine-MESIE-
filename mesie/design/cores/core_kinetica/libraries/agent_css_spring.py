"""Agent Elasticus Phi — CSS Spring Physics intelligence agent."""
...
PARADIGM_ID = "css_spring"
LATIN_AGENT = "Agent Elasticus Phi"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Elasticus Phi — routes to MESIE engine control."""
