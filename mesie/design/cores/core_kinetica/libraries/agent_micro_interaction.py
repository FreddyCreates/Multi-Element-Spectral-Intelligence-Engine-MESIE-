"""Agent Parvus Motus — Micro-interactions intelligence agent."""
...
PARADIGM_ID = "micro_interaction"
LATIN_AGENT = "Agent Parvus Motus"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Parvus Motus — routes to MESIE engine matching."""
