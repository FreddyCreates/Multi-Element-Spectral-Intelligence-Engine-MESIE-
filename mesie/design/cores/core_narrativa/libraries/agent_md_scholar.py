"""Agent Markdown Doctoralis — Scholarly Markdown intelligence agent."""
...
PARADIGM_ID = "md_scholar"
LATIN_AGENT = "Agent Markdown Doctoralis"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Markdown Doctoralis — routes to MESIE engine generation."""
