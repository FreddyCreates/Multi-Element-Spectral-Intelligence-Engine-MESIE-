"""Agent Typus Doctoralis — φ Scholar Typography intelligence agent."""
...
PARADIGM_ID = "phi_typography"
LATIN_AGENT = "Agent Typus Doctoralis"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Typus Doctoralis — routes to MESIE engine generation."""
