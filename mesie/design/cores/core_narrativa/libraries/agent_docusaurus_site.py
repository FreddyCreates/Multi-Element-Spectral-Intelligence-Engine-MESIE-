"""Agent Docusaurus Polyglotta — Docusaurus intelligence agent."""
...
CORE_ID = "core_narrativa"
PARADIGM_ID = "docusaurus_site"
LATIN_AGENT = "Agent Docusaurus Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Docusaurus Polyglotta — routes to MESIE engine embedding."""
