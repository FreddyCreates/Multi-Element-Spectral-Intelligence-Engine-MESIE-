"""Agent Fasciculus Research — Research Pack UI intelligence agent."""
...
PARADIGM_ID = "research_pack"
LATIN_AGENT = "Agent Fasciculus Research"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Fasciculus Research — routes to MESIE engine embedding."""
