"""Agent Sphinx Polyglotta — Sphinx RST intelligence agent."""
...
PARADIGM_ID = "rst_sphinx"
LATIN_AGENT = "Agent Sphinx Polyglotta"
ROLE = "orchestrator"
MESIE_ENGINE = "logic"
STACK = "sphinx"
LANGUAGE = "wasm"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Sphinx Polyglotta — routes to MESIE engine logic."""
