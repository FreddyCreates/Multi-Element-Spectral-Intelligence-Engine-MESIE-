"""Agent AsciiDoc Polyglotta — AsciiDoc intelligence agent."""
...
PARADIGM_ID = "asciidoc_book"
LATIN_AGENT = "Agent AsciiDoc Polyglotta"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent AsciiDoc Polyglotta — routes to MESIE engine workflow."""
