"""Agent LaTeX Polyglotta — LaTeX PDF intelligence agent."""
...
PARADIGM_ID = "latex_pdf"
LATIN_AGENT = "Agent LaTeX Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent LaTeX Polyglotta — routes to MESIE engine polyglot."""
