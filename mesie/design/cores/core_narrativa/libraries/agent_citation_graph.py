"""Agent Citatio Retis — Citation Graph intelligence agent."""
...
PARADIGM_ID = "citation_graph"
LATIN_AGENT = "Agent Citatio Retis"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Citatio Retis — routes to MESIE engine matching."""
