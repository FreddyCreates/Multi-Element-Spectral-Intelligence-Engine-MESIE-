"""Agent VitePress Polyglotta — VitePress intelligence agent."""
...
PARADIGM_ID = "vitepress_docs"
LATIN_AGENT = "Agent VitePress Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent VitePress Polyglotta — routes to MESIE engine matching."""
