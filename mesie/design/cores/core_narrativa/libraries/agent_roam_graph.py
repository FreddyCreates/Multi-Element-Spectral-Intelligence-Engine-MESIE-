"""Agent Roam Polyglotta — Roam Graph intelligence agent."""
...
PARADIGM_ID = "roam_graph"
LATIN_AGENT = "Agent Roam Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Roam Polyglotta — routes to MESIE engine movement."""
