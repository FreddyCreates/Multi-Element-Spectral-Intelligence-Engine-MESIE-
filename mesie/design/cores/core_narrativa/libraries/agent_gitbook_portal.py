"""Agent GitBook Polyglotta — GitBook intelligence agent."""
...
PARADIGM_ID = "gitbook_portal"
LATIN_AGENT = "Agent GitBook Polyglotta"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent GitBook Polyglotta — routes to MESIE engine control."""
