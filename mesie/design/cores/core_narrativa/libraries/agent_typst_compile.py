"""Agent Typst Polyglotta — Typst intelligence agent."""
...
PARADIGM_ID = "typst_compile"
LATIN_AGENT = "Agent Typst Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Typst Polyglotta — routes to MESIE engine generation."""
