"""Agent Vega-Lite Polyglotta — Vega-Lite intelligence agent."""
...
PARADIGM_ID = "vega_lite"
LATIN_AGENT = "Agent Vega-Lite Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Vega-Lite Polyglotta — routes to MESIE engine embedding."""
