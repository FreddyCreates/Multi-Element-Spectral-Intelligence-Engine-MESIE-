"""Agent Chart Canvas — Canvas Charts intelligence agent."""
...
PARADIGM_ID = "canvas_chart"
LATIN_AGENT = "Agent Chart Canvas"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Chart Canvas — routes to MESIE engine generation."""
