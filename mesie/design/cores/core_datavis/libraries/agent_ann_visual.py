"""Agent Vicinitas Visualis — ANN Match Visual intelligence agent."""
...
PARADIGM_ID = "ann_visual"
LATIN_AGENT = "Agent Vicinitas Visualis"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Vicinitas Visualis — routes to MESIE engine matching."""
