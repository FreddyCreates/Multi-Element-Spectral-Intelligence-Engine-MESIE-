"""Agent Observable Polyglotta — Observable intelligence agent."""
...
PARADIGM_ID = "observable_notebook"
LATIN_AGENT = "Agent Observable Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Observable Polyglotta — routes to MESIE engine matching."""
