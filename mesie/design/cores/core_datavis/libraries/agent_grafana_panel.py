"""Agent Grafana Polyglotta — Grafana Panel intelligence agent."""
...
PARADIGM_ID = "grafana_panel"
LATIN_AGENT = "Agent Grafana Polyglotta"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Grafana Polyglotta — routes to MESIE engine control."""
