"""Agent Metrum Aureum — φ Gauge Widget intelligence agent."""
...
PARADIGM_ID = "phi_gauge"
LATIN_AGENT = "Agent Metrum Aureum"
ROLE = "helper"
MESIE_ENGINE = "logic"
STACK = "gauge"
LANGUAGE = "gauge"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Metrum Aureum — routes to MESIE engine logic."""
