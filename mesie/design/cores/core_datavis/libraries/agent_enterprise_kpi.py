"""Agent Indicium Mercatus — Enterprise KPI intelligence agent."""
...
PARADIGM_ID = "enterprise_kpi"
LATIN_AGENT = "Agent Indicium Mercatus"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Indicium Mercatus — routes to MESIE engine intelligence."""
