"""Agent ECharts Polyglotta — ECharts Spectral intelligence agent."""
...
CORE_ID = "core_datavis"
PARADIGM_ID = "echarts_spectral"
LATIN_AGENT = "Agent ECharts Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent ECharts Polyglotta — routes to MESIE engine polyglot."""
