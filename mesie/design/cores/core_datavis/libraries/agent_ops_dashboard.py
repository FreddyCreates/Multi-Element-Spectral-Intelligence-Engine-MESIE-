"""Agent Tabula Imperii — 4K Ops Dashboard intelligence agent."""
...
PARADIGM_ID = "ops_dashboard"
LATIN_AGENT = "Agent Tabula Imperii"
ROLE = "orchestrator"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Tabula Imperii — routes to MESIE engine control."""
