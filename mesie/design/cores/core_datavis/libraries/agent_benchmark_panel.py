"""Agent Metrum Competitio — Benchmark Panel intelligence agent."""
...
PARADIGM_ID = "benchmark_panel"
LATIN_AGENT = "Agent Metrum Competitio"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Metrum Competitio — routes to MESIE engine validation."""
