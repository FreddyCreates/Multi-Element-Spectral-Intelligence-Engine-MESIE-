"""Agent Calor Cartographia — WebGL Heatmap intelligence agent."""
...
PARADIGM_ID = "webgl_heatmap"
LATIN_AGENT = "Agent Calor Cartographia"
ROLE = "executor"
MESIE_ENGINE = "fingerprint"
STACK = "heatmap"
LANGUAGE = "heatmap"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Calor Cartographia — routes to MESIE engine fingerprint."""
