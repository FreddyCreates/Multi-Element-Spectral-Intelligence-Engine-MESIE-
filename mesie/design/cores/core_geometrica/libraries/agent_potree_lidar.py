"""Agent Potree Polyglotta — Potree LiDAR intelligence agent."""
...
PARADIGM_ID = "potree_lidar"
LATIN_AGENT = "Agent Potree Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Potree Polyglotta — routes to MESIE engine matching."""
