"""Agent Babylon Spectralis — Babylon.js PBR intelligence agent."""
...
PARADIGM_ID = "babylon_pbr"
LATIN_AGENT = "Agent Babylon Spectralis"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Babylon Spectralis — routes to MESIE engine generation."""
