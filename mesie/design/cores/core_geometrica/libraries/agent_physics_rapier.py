"""Agent Physica Collisio — Rapier Physics intelligence agent."""
...
PARADIGM_ID = "physics_rapier"
LATIN_AGENT = "Agent Physica Collisio"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Physica Collisio — routes to MESIE engine movement."""
