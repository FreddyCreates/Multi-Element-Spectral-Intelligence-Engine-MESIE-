"""Agent Cesium Polyglotta — Cesium Globe intelligence agent."""
...
PARADIGM_ID = "cesium_globe"
LATIN_AGENT = "Agent Cesium Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Cesium Polyglotta — routes to MESIE engine embedding."""
