"""Agent regl Polyglotta — regl Pipeline intelligence agent."""
...
PARADIGM_ID = "regl_pipeline"
LATIN_AGENT = "Agent regl Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent regl Polyglotta — routes to MESIE engine generation."""
