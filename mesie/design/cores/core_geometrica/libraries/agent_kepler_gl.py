"""Agent Kepler.gl Polyglotta — Kepler.gl intelligence agent."""
...
PARADIGM_ID = "kepler_gl"
LATIN_AGENT = "Agent Kepler.gl Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Kepler.gl Polyglotta — routes to MESIE engine intelligence."""
