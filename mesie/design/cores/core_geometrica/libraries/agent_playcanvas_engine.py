"""Agent PlayCanvas Polyglotta — PlayCanvas Engine intelligence agent."""
...
PARADIGM_ID = "playcanvas_engine"
LATIN_AGENT = "Agent PlayCanvas Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent PlayCanvas Polyglotta — routes to MESIE engine polyglot."""
