"""Agent Multitudo Mesh — Instanced Mesh intelligence agent."""
...
PARADIGM_ID = "instanced_mesh"
LATIN_AGENT = "Agent Multitudo Mesh"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Multitudo Mesh — routes to MESIE engine matching."""
