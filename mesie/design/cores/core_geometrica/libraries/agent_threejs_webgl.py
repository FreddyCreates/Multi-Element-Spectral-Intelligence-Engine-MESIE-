"""Agent Geometria Triangula — Three.js WebGL intelligence agent."""
...
LATIN_AGENT = "Agent Geometria Triangula"
ROLE = "orchestrator"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Geometria Triangula — routes to MESIE engine movement."""
