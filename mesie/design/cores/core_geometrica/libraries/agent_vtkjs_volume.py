"""Agent VTK.js Polyglotta — VTK.js Volume intelligence agent."""
...
PARADIGM_ID = "vtkjs_volume"
LATIN_AGENT = "Agent VTK.js Polyglotta"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent VTK.js Polyglotta — routes to MESIE engine control."""
