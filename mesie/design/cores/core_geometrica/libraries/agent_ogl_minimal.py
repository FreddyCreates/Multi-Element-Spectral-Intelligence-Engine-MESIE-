"""Agent OGL Polyglotta — OGL Minimal intelligence agent."""
...
PARADIGM_ID = "ogl_minimal"
LATIN_AGENT = "Agent OGL Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent OGL Polyglotta — routes to MESIE engine movement."""
