"""Agent Shader Harmonicus — GLSL Shaders intelligence agent."""
...
PARADIGM_ID = "shader_glsl"
LATIN_AGENT = "Agent Shader Harmonicus"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Shader Harmonicus — routes to MESIE engine fingerprint."""
