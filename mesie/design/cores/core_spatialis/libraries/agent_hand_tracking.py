"""Agent Manus Digitalis — Hand Tracking UI intelligence agent."""
...
PARADIGM_ID = "hand_tracking"
LATIN_AGENT = "Agent Manus Digitalis"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Manus Digitalis — routes to MESIE engine fingerprint."""
