"""Agent WebVM Polyglotta — WebVM Spatial intelligence agent."""
...
PARADIGM_ID = "webvm_spatial"
LATIN_AGENT = "Agent WebVM Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent WebVM Polyglotta — routes to MESIE engine movement."""
