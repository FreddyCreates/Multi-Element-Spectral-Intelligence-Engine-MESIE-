"""Agent Quest Polyglotta — Quest Browser intelligence agent."""
...
PARADIGM_ID = "quest_browser"
LATIN_AGENT = "Agent Quest Polyglotta"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Quest Polyglotta — routes to MESIE engine control."""
