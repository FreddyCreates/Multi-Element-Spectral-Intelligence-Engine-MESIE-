"""Agent Sex Libertatis — 6DOF Widgets intelligence agent."""
...
PARADIGM_ID = "6dof_widget"
LATIN_AGENT = "Agent Sex Libertatis"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Sex Libertatis — routes to MESIE engine control."""
