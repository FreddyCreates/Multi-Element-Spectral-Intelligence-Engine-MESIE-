"""Agent 8th Polyglotta — 8th Wall WebAR intelligence agent."""
...
PARADIGM_ID = "8thwall_webar"
LATIN_AGENT = "Agent 8th Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent 8th Polyglotta — routes to MESIE engine embedding."""
