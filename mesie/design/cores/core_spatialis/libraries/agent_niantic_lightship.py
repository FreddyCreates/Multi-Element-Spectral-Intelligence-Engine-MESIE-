"""Agent Lightship Polyglotta — Lightship VPS intelligence agent."""
...
PARADIGM_ID = "niantic_lightship"
LATIN_AGENT = "Agent Lightship Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Lightship Polyglotta — routes to MESIE engine intelligence."""
