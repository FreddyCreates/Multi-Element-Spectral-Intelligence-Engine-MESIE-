"""Agent A-Frame Polyglotta — A-Frame Scene intelligence agent."""
...
PARADIGM_ID = "aframe_scene"
LATIN_AGENT = "Agent A-Frame Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent A-Frame Polyglotta — routes to MESIE engine polyglot."""
