"""Agent Superpositio Realis — AR Overlay intelligence agent."""
...
PARADIGM_ID = "ar_overlay"
LATIN_AGENT = "Agent Superpositio Realis"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Superpositio Realis — routes to MESIE engine intelligence."""
