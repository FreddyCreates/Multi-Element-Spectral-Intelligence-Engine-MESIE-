"""Agent Hand Polyglotta — Hand UI Gesture intelligence agent."""
...
PARADIGM_ID = "hand_ui_gesture"
LATIN_AGENT = "Agent Hand Polyglotta"
ROLE = "orchestrator"
MESIE_ENGINE = "logic"
STACK = "gesture"
LANGUAGE = "wasm"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Hand Polyglotta — routes to MESIE engine logic."""
