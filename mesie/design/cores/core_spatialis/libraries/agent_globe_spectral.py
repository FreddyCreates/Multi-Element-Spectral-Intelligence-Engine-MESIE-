"""Agent Globus Mundi — Spectral Globe intelligence agent."""
...
PARADIGM_ID = "globe_spectral"
LATIN_AGENT = "Agent Globus Mundi"
ROLE = "orchestrator"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Globus Mundi — routes to MESIE engine matching."""
