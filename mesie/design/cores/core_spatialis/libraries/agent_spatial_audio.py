"""Agent Sonus Spatialis — Spatial Audio intelligence agent."""
...
CORE_ID = "core_spatialis"
PARADIGM_ID = "spatial_audio"
LATIN_AGENT = "Agent Sonus Spatialis"
ROLE = "helper"
MESIE_ENGINE = "embedding"
STACK = "spatial_audio"
LANGUAGE = "spatial_audio"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Sonus Spatialis — routes to MESIE engine embedding."""
