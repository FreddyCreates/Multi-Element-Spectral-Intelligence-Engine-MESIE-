"""Agent Godot Polyglotta — Godot Web Export intelligence agent."""
...
PARADIGM_ID = "godot_web_export"
LATIN_AGENT = "Agent Godot Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Godot Polyglotta — routes to MESIE engine polyglot."""
