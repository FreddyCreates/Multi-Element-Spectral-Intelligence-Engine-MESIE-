"""Agent Post Processus — Post-Processing FX intelligence agent."""
...
PARADIGM_ID = "post_fx"
LATIN_AGENT = "Agent Post Processus"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Post Processus — routes to MESIE engine generation."""
