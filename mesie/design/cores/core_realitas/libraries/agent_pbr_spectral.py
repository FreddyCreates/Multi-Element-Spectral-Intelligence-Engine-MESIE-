"""Agent Materia Physica — Spectral PBR Materials intelligence agent."""
...
PARADIGM_ID = "pbr_spectral"
LATIN_AGENT = "Agent Materia Physica"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Materia Physica — routes to MESIE engine embedding."""
