"""Agent Lux Harmonica — Light Probe φ intelligence agent."""
...
PARADIGM_ID = "light_probe"
LATIN_AGENT = "Agent Lux Harmonica"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Lux Harmonica — routes to MESIE engine fingerprint."""
