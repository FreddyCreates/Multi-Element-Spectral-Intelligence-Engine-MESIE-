"""Agent Blender Polyglotta — Blender glTF intelligence agent."""
...
PARADIGM_ID = "blender_gltf"
LATIN_AGENT = "Agent Blender Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Blender Polyglotta — routes to MESIE engine embedding."""
