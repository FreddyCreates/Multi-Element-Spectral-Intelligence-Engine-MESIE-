"""Agent Reality Polyglotta — Reality Composer Pro intelligence agent."""
...
PARADIGM_ID = "reality_composer_pro"
LATIN_AGENT = "Agent Reality Polyglotta"
ROLE = "orchestrator"
MESIE_ENGINE = "logic"
STACK = "rcp"
LANGUAGE = "wasm"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Reality Polyglotta — routes to MESIE engine logic."""
