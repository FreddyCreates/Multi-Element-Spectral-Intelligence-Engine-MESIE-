"""Agent Unity Polyglotta — Unity WebGL intelligence agent."""
...
PARADIGM_ID = "unity_webgl"
LATIN_AGENT = "Agent Unity Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Unity Polyglotta — routes to MESIE engine generation."""
