"""Agent Booth Mercatus — Virtual Trade Booth intelligence agent."""
...
PARADIGM_ID = "virtual_booth"
LATIN_AGENT = "Agent Booth Mercatus"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Booth Mercatus — routes to MESIE engine movement."""
