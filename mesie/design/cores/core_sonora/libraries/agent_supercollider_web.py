"""Agent SuperCollider Polyglotta — SuperCollider Web intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "supercollider_web"
LATIN_AGENT = "Agent SuperCollider Polyglotta"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent SuperCollider Polyglotta — routes to MESIE engine validation."""
