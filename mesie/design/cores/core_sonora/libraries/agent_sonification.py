"""Agent Data Sonora — Data Sonification intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "sonification"
LATIN_AGENT = "Agent Data Sonora"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Data Sonora — routes to MESIE engine generation."""
