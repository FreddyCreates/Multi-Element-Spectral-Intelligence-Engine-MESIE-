"""Agent Pulsus Novae — Rhythm Pulse NOVA intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "rhythm_pulse"
LATIN_AGENT = "Agent Pulsus Novae"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Pulsus Novae — routes to MESIE engine workflow."""
