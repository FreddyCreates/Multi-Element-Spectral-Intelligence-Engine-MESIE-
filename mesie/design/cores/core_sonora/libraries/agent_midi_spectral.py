"""Agent Nota Frequens — MIDI Spectral Map intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "midi_spectral"
LATIN_AGENT = "Agent Nota Frequens"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Nota Frequens — routes to MESIE engine embedding."""
