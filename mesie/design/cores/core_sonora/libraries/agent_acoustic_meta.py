"""Agent Metamateria Soni — Acoustic Metamaterial UI intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "acoustic_meta"
LATIN_AGENT = "Agent Metamateria Soni"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Metamateria Soni — routes to MESIE engine intelligence."""
