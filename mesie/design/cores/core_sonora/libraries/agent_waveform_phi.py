"""Agent Unda Harmonica — φ Waveform intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "waveform_phi"
LATIN_AGENT = "Agent Unda Harmonica"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Unda Harmonica — routes to MESIE engine matching."""
