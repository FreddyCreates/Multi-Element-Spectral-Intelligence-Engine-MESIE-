"""Agent WaveSurfer Polyglotta — WaveSurfer intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "wavesurfer_ui"
LATIN_AGENT = "Agent WaveSurfer Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent WaveSurfer Polyglotta — routes to MESIE engine embedding."""
