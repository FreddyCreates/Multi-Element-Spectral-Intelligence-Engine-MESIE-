"""Agent Sonus Syntheticus — WebAudio Synth intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "webaudio_synth"
LATIN_AGENT = "Agent Sonus Syntheticus"
ROLE = "orchestrator"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Sonus Syntheticus — routes to MESIE engine generation."""
