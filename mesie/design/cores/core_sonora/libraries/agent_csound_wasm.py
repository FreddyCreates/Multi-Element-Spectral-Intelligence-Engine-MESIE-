"""Agent Csound Polyglotta — Csound WASM intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "csound_wasm"
LATIN_AGENT = "Agent Csound Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Csound Polyglotta — routes to MESIE engine movement."""
