"""Agent Aequilibrium — EQ Spectrum Match intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "eq_spectrum"
LATIN_AGENT = "Agent Aequilibrium"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Aequilibrium — routes to MESIE engine matching."""
