"""Agent Spectrogramma — Spectrogram Live intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "spectrogram"
LATIN_AGENT = "Agent Spectrogramma"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Spectrogramma — routes to MESIE engine fingerprint."""
