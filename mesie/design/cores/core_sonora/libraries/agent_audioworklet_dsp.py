"""Agent AudioWorklet Polyglotta — AudioWorklet DSP intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "audioworklet_dsp"
LATIN_AGENT = "Agent AudioWorklet Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent AudioWorklet Polyglotta — routes to MESIE engine matching."""
