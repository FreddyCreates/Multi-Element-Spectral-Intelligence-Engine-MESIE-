"""Agent p5.sound Polyglotta — p5.sound intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "p5_sound"
LATIN_AGENT = "Agent p5.sound Polyglotta"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent p5.sound Polyglotta — routes to MESIE engine workflow."""
