"""Agent Binauralis — Binaural Spatial intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "binaural"
LATIN_AGENT = "Agent Binauralis"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Binauralis — routes to MESIE engine control."""
