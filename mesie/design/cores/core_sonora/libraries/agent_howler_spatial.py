"""Agent Howler.js Polyglotta — Howler.js intelligence agent."""
...
CORE_ID = "core_sonora"
PARADIGM_ID = "howler_spatial"
LATIN_AGENT = "Agent Howler.js Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Howler.js Polyglotta — routes to MESIE engine generation."""
