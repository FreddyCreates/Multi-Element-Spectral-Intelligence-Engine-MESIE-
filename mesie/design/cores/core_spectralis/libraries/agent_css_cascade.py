"""Agent Stylus Harmonicus — CSS Cascade intelligence agent."""
...
PARADIGM_ID = "css_cascade"
LATIN_AGENT = "Agent Stylus Harmonicus"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Stylus Harmonicus — routes to MESIE engine generation."""
