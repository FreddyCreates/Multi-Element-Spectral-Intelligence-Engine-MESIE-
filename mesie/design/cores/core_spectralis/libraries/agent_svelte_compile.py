"""Agent Compiler Minimus — Svelte Compile intelligence agent."""
...
PARADIGM_ID = "svelte_compile"
LATIN_AGENT = "Agent Compiler Minimus"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Compiler Minimus — routes to MESIE engine generation."""
