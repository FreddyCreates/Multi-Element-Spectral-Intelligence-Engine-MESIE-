"""Agent Shadow Domus — Web Components intelligence agent."""
...
PARADIGM_ID = "web_components"
LATIN_AGENT = "Agent Shadow Domus"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Shadow Domus — routes to MESIE engine embedding."""
