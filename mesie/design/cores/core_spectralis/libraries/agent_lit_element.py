"""Agent Lit Polyglotta — Lit Web Components intelligence agent."""
...
PARADIGM_ID = "lit_element"
LATIN_AGENT = "Agent Lit Polyglotta"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Lit Polyglotta — routes to MESIE engine control."""
