"""Agent HTMX Polyglotta — HTMX Hypermedia intelligence agent."""
...
PARADIGM_ID = "htmx_hypermedia"
LATIN_AGENT = "Agent HTMX Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent HTMX Polyglotta — routes to MESIE engine intelligence."""
