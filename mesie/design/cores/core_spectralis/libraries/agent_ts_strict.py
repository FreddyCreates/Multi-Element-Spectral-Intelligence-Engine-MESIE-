"""Agent Typus Formalis — TypeScript Strict intelligence agent."""
...
PARADIGM_ID = "ts_strict"
LATIN_AGENT = "Agent Typus Formalis"
ROLE = "helper"
MESIE_ENGINE = "logic"
STACK = "typescript"
LANGUAGE = "typescript"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Typus Formalis — routes to MESIE engine logic."""
