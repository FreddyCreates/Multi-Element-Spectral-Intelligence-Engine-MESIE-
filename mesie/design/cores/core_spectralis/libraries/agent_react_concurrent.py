"""Agent Componentia Fluxus — React Concurrent intelligence agent."""
...
PARADIGM_ID = "react_concurrent"
LATIN_AGENT = "Agent Componentia Fluxus"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Componentia Fluxus — routes to MESIE engine workflow."""
