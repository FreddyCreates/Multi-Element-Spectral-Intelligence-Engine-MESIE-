"""Agent Reactivus Componens — Vue Composition intelligence agent."""
...
PARADIGM_ID = "vue_compose"
LATIN_AGENT = "Agent Reactivus Componens"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Reactivus Componens — routes to MESIE engine workflow."""
