"""Agent Insula Statica — Astro Islands intelligence agent."""
...
PARADIGM_ID = "astro_islands"
LATIN_AGENT = "Agent Insula Statica"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Insula Statica — routes to MESIE engine polyglot."""
