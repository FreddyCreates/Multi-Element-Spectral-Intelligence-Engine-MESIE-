"""Agent Systema Materialis — Design System Package intelligence agent."""
...
PARADIGM_ID = "design_system_pkg"
LATIN_AGENT = "Agent Systema Materialis"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Systema Materialis — routes to MESIE engine embedding."""
