"""Agent single-spa Polyglotta — single-spa intelligence agent."""
...
PARADIGM_ID = "single_spa"
LATIN_AGENT = "Agent single-spa Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent single-spa Polyglotta — routes to MESIE engine polyglot."""
