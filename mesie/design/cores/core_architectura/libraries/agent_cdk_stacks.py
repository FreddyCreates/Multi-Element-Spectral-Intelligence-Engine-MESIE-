"""Agent AWS Polyglotta — AWS CDK UI intelligence agent."""
...
PARADIGM_ID = "cdk_stacks"
LATIN_AGENT = "Agent AWS Polyglotta"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent AWS Polyglotta — routes to MESIE engine intelligence."""
