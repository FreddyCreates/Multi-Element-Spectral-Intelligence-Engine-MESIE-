"""Agent Schema Intermedius — BFF GraphQL intelligence agent."""
...
PARADIGM_ID = "bff_graphql"
LATIN_AGENT = "Agent Schema Intermedius"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Schema Intermedius — routes to MESIE engine validation."""
