"""Agent Terraform Polyglotta — Terraform UI intelligence agent."""
...
PARADIGM_ID = "terraform_ui"
LATIN_AGENT = "Agent Terraform Polyglotta"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Terraform Polyglotta — routes to MESIE engine validation."""
