"""Agent Server Marginalis — Edge SSR intelligence agent."""
...
PARADIGM_ID = "edge_ssr"
LATIN_AGENT = "Agent Server Marginalis"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Server Marginalis — routes to MESIE engine control."""
