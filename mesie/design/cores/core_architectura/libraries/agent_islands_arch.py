"""Agent Archipelagus UI — Islands Architecture intelligence agent."""
...
PARADIGM_ID = "islands_arch"
LATIN_AGENT = "Agent Archipelagus UI"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Archipelagus UI — routes to MESIE engine generation."""
