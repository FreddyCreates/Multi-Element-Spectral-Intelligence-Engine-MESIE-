"""Agent qiankun Polyglotta — qiankun Micro intelligence agent."""
...
PARADIGM_ID = "qiankun_micro"
LATIN_AGENT = "Agent qiankun Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent qiankun Polyglotta — routes to MESIE engine generation."""
