"""Agent Nx Polyglotta — Nx Monorepo intelligence agent."""
...
PARADIGM_ID = "nx_monorepo"
LATIN_AGENT = "Agent Nx Polyglotta"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Nx Polyglotta — routes to MESIE engine workflow."""
