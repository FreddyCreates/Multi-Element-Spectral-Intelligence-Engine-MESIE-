"""Agent K8s Polyglotta — K8s Dashboard intelligence agent."""
...
PARADIGM_ID = "k8s_dashboard"
LATIN_AGENT = "Agent K8s Polyglotta"
ROLE = "worker"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent K8s Polyglotta — routes to MESIE engine movement."""
