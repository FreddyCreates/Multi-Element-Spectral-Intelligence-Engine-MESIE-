"""Agent Colonia Tenant — Multi-Tenant Shell intelligence agent."""
...
PARADIGM_ID = "tenant_shell"
LATIN_AGENT = "Agent Colonia Tenant"
ROLE = "orchestrator"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Colonia Tenant — routes to MESIE engine control."""
