"""Agent Catena Probationis — Receipt Chain UI intelligence agent."""
...
PARADIGM_ID = "receipt_ui"
LATIN_AGENT = "Agent Catena Probationis"
ROLE = "helper"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Catena Probationis — routes to MESIE engine workflow."""
