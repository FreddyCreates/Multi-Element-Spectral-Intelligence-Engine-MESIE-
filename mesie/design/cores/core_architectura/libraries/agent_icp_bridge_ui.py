"""Agent Pontus Sovereign — ICP Bridge Console intelligence agent."""
...
PARADIGM_ID = "icp_bridge_ui"
LATIN_AGENT = "Agent Pontus Sovereign"
ROLE = "executor"
...
def run_agent(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute Agent Pontus Sovereign — routes to MESIE engine polyglot."""
