/**
 * HERMES H07 — Wrangler Forge
 * NOVA PROTOCOL · ItsnotAILabs · hermes-wrangler
 */
export default {
  async fetch(request, env, ctx) {
    ...
    const meta = {
      ...
      worker_id: "hermes-wrangler",
      slot: "H07",
      category: "deploy",
      operations: ['toml', 'routes', 'vars'],
      processor_proxy: "GET /processor/hermes",
    ...
    try {
      ...
      const proxyPath = routeToProcessor("hermes-wrangler");
      ...
      return Response.json({
        ...
        hermes: meta,
        error: String(err),
        offline_pack: "deliverables/hermes/packages/hermes-wrangler.json",
