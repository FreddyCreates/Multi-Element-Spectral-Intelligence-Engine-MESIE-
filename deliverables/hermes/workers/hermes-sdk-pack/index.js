/**
 * HERMES H08 — SDK Packager
 * NOVA PROTOCOL · ItsnotAILabs · hermes-sdk-pack
 */
export default {
  async fetch(request, env, ctx) {
    ...
    const meta = {
      ...
      worker_id: "hermes-sdk-pack",
      slot: "H08",
      category: "sdk",
      operations: ['bundle', 'version', 'export'],
      processor_proxy: "GET /processor/models",
    ...
    try {
      ...
      const proxyPath = routeToProcessor("hermes-sdk-pack");
      ...
      return Response.json({
        ...
        hermes: meta,
        error: String(err),
        offline_pack: "deliverables/hermes/packages/hermes-sdk-pack.json",
