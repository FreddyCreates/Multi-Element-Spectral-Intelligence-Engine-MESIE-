/**
 * HERMES H11 — Clean Internet Feed
 * NOVA PROTOCOL · ItsnotAILabs · hermes-clean-feed
 */
export default {
  async fetch(request, env, ctx) {
    ...
    const meta = {
      ...
      worker_id: "hermes-clean-feed",
      slot: "H11",
      category: "clean_internet",
      operations: ['filter', 'sanitize', 'provenance'],
      processor_proxy: "GET /processor/hermes/nova-protocol",
    ...
    try {
      ...
      const proxyPath = routeToProcessor("hermes-clean-feed");
      ...
      return Response.json({
        ...
        hermes: meta,
        error: String(err),
        offline_pack: "deliverables/hermes/packages/hermes-clean-feed.json",
