/**
 * HERMES H10 — NOVA Pulse
 * NOVA PROTOCOL · ItsnotAILabs · hermes-nova-pulse
 */
export default {
  async fetch(request, env, ctx) {
    ...
    const meta = {
      ...
      worker_id: "hermes-nova-pulse",
      slot: "H10",
      category: "nova",
      operations: ['career_pulse', 'runtime_tick', 'lrc_mint'],
      processor_proxy: "GET /processor/grok/protocol",
    ...
    try {
      ...
      const proxyPath = routeToProcessor("hermes-nova-pulse");
      ...
      return Response.json({
        ...
        hermes: meta,
        error: String(err),
        offline_pack: "deliverables/hermes/packages/hermes-nova-pulse.json",
