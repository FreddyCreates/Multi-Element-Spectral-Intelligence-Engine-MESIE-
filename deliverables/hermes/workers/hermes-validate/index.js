/**
 * HERMES H03 — Spectral Validate
 * NOVA PROTOCOL · ItsnotAILabs · hermes-validate
 */
export default {
  async fetch(request, env, ctx) {
    ...
    const meta = {
      ...
      worker_id: "hermes-validate",
      slot: "H03",
      category: "quality",
      operations: ['schema_check', 'level_gate'],
      processor_proxy: "POST /processor/validate",
    ...
    try {
      ...
      const proxyPath = routeToProcessor("hermes-validate");
      ...
      return Response.json({
        ...
        hermes: meta,
        error: String(err),
        offline_pack: "deliverables/hermes/packages/hermes-validate.json",
