/**
 * HERMES H12 — One-Shot Deploy
 * NOVA PROTOCOL · ItsnotAILabs · hermes-deploy-shot
 */
export default {
  async fetch(request, env, ctx) {
    ...
    const meta = {
      ...
      worker_id: "hermes-deploy-shot",
      slot: "H12",
      category: "execution",
      operations: ['pack', 'verify', 'ship'],
      processor_proxy: "POST /processor/hermes/forge",
    ...
    try {
      ...
      const proxyPath = routeToProcessor("hermes-deploy-shot");
      ...
      return Response.json({
        ...
        hermes: meta,
        error: String(err),
        offline_pack: "deliverables/hermes/packages/hermes-deploy-shot.json",
