/**
 * HERMES H04 — ANN Match Lane
 * NOVA PROTOCOL · ItsnotAILabs · hermes-match
 */
export default {
  async fetch(request, env, ctx) {
    ...
    const meta = {
      ...
      worker_id: "hermes-match",
      slot: "H04",
      category: "retrieval",
      operations: ['top_k', 'cosine', 'lsh'],
      processor_proxy: "POST /processor/match",
    ...
    try {
      ...
      const proxyPath = routeToProcessor("hermes-match");
      ...
      return Response.json({
        ...
        hermes: meta,
        error: String(err),
        offline_pack: "deliverables/hermes/packages/hermes-match.json",
