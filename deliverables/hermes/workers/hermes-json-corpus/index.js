/**
 * HERMES H09 — JSON Corpus Pack
 * NOVA PROTOCOL · ItsnotAILabs · hermes-json-corpus
 */
export default {
  async fetch(request, env, ctx) {
    ...
    const meta = {
      ...
      worker_id: "hermes-json-corpus",
      slot: "H09",
      category: "large_data",
      operations: ['harvest', 'slice', 'export_jsonl'],
      processor_proxy: "POST /processor/platform/producer-pipeline/invoke",
    ...
    try {
      ...
      const proxyPath = routeToProcessor("hermes-json-corpus");
      ...
      return Response.json({
        ...
        hermes: meta,
        error: String(err),
        offline_pack: "deliverables/hermes/packages/hermes-json-corpus.json",
