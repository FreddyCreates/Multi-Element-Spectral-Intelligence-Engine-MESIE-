/**
 * HERMES H01 — Ingest Envelope
 * NOVA PROTOCOL · ItsnotAILabs · hermes-ingest
 */
export default {
  async fetch(request, env, ctx) {
    ...
    const meta = {
      ...
      worker_id: "hermes-ingest",
      slot: "H01",
      category: "ingestion",
      operations: ['receive', 'normalize', 'receipt'],
      processor_proxy: "POST /processor/embed",
    ...
    try {
      ...
      const proxyPath = routeToProcessor("hermes-ingest");
      ...
      return Response.json({
        ...
        hermes: meta,
        error: String(err),
        offline_pack: "deliverables/hermes/packages/hermes-ingest.json",
