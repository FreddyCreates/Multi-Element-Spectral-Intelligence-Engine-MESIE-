/**
 * HERMES H05 — Federated Envelope
 * NOVA PROTOCOL · ItsnotAILabs · hermes-envelope
 */
export default {
  async fetch(request, env, ctx) {
    ...
    const meta = {
      ...
      worker_id: "hermes-envelope",
      slot: "H05",
      category: "federation",
      operations: ['wrap', 'unwrap', 'route'],
      processor_proxy: "POST /processor/grok/worker",
    ...
    try {
      ...
      const proxyPath = routeToProcessor("hermes-envelope");
      ...
      return Response.json({
        ...
        hermes: meta,
        error: String(err),
        offline_pack: "deliverables/hermes/packages/hermes-envelope.json",
