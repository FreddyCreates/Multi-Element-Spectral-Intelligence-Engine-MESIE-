/**
 * HERMES H02 — Edge Embed Proxy
 * NOVA PROTOCOL · ItsnotAILabs · hermes-embed
 */
export default {
  async fetch(request, env, ctx) {
    ...
    const meta = {
      ...
      worker_id: "hermes-embed",
      slot: "H02",
      category: "embedding",
      operations: ['encode', 'batch_encode', 'phi_kernel'],
      processor_proxy: "POST /processor/compute/encode",
    ...
    try {
      ...
      const proxyPath = routeToProcessor("hermes-embed");
      ...
      return Response.json({
        ...
        hermes: meta,
        error: String(err),
        offline_pack: "deliverables/hermes/packages/hermes-embed.json",
