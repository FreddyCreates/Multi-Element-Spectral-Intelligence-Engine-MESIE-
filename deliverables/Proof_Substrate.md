...
**Verdict:** `partially_true_software_substrate` | **Seal:** `2144e43657dfc8a8…`
...
- **Tier:** Measured on edge deployment class — reproducible harness on issued field/lab hardware
- **Measured:** p50 threat-fast ~0.85ms on edge-class ARM64 harness
- **Limit:** Single edge node harness; customer program repro is the corroboration path
...
- **Tier:** Software simulation validated on sovereign stack (not physical range HIL yet)
- **Measured:** ~0.05-0.11 ms/agent cluster-optimized in software sim
- **Limit:** In-process cluster math today; multi-host LAN soak extends same edge path
...
- **Tier:** Named gap — specific physical asset or audit not yet demonstrated
...
- **Limit:** Sovereign interior DC + edge appliance; pen test on customer deploy
...
- **Limit:** Builder lab (LLC) publishes harness; customer/GSA repro is industry path
